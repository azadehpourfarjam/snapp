...
export interface SwiperOptions {
  ...
  /**
   * Enables history push state where every slide will have its own url. In this parameter you have to specify js slides url like `"slides"` and specify every slide url using `data-history` attribute.
   *
